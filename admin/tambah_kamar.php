...
if ($foto !="") {
    ...
    if (in_array($extensi, $extensi_diperbolehkan) === true) {
        ...
        $query = "INSERT INTO kamar (jenis_kamar,harga,foto) VALUES ('$jenis_kamar','$harga','$nama_gambar_baru')";
    ...
    $query = "INSERT INTO kamar (jenis_kamar,harga,foto) VALUES ('$jenis_kamar','$harga', null)";
    $result = mysqli_query($koneksi, $query);
