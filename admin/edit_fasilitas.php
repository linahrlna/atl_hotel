...
<head>
  ...
  <link rel="icon" type="image/png" href="../assets/dist/gambar/logo-atl.png">
                      ...
                      <select name="id_kamar" class="form-control">
                        ...
                        while ($a = mysqli_fetch_array($kamar)) {
                          if ($a['id_kamar'] == $d['id_kamar']) { ?>
                            <option value="<?php echo $a['id_kamar']; ?>" selected><?php echo $a['jenis_kamar']; ?></option>";
                          <?php }else{ ?>
                            <option value="<?php echo $a['id_kamar']; ?>"><?php echo $a['jenis_kamar']; ?></option>";
                          <?php }
                        }
                        ?>  
                      </select>
          ...
          <form action="tambah_fasilitas.php" method="POST">
            <div class="form-group">
              ...
              <select name="id_kamar" class="form-control">
                ...
                while ($d = mysqli_fetch_array($data)) { 
                  ?>
                  <option value="<?php echo $d['id_kamar']; ?>"><?php echo $d['jenis_kamar']; ?></option>
                  <?php
                }
                ?>
              </select>
