  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="assets/index3.html" class="navbar-brand">
        <img src="assets/dist/img/logo-atl.png" class="brand-image img-square " >
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Atlantic Hotel</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                      <img class="d-block w-100" src="assets/gambar/k3.jpg" alt="Second slide" height="550">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="assets/gambar/g2.jpg" alt="Third slide" height="550">
                    </div>
                  </div>
            ...
            <div class="form-group">
                    ...
                    <select name="id_kamar" class="form-control">
                        ...
                        while ($d = mysqli_fetch_array($data)) { 
                          ?>
                          <option value="<?php echo $d['id_kamar']; ?>"><?php echo $d['jenis_kamar']; ?>|<?php echo $d['harga']; ?></option>
                          <?php
                        }
                        ?>
                    </select>
        ...
        <!-- /.modal-dialog -->
          ...
          <div class="col-md-12">
            <div class="card-body">
              ...
              <p class="text-center">Selamat datang di hotel kami semoga liburan anda menyenangkan. Silahkan memesan kamar yang anda inginkan</p>
            </div>
          </div>
          </div>
      </div><!-- /.container-fluid -->
